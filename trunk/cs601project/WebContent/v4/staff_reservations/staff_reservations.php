...
?>
<script
	type="text/javascript" src="../javascript/jquery.staff_reservation.js"></script>
<script
	type="text/javascript" src="../javascript/jquery.datetime.js"></script>
<script
...
<fieldset class="searchcriteria">
	...
	<form name="reservationsearch" id="reservationsearch" method="GET"
		...
		<br> <br> <label for="sortorder">display in order:</label> <select
			...
			<option value="ASC"
			<?php echo ($reservation->getSortOrder()=='ASC')?'selected':'';?>>ascending</option>
			<option value="DESC"
			<?php echo ($reservation->getSortOrder()=='DESC')?'selected':'';?>>descending</option>
	...
	<div>
		...
		<form name="resstatusupdate<?php echo $resid; ?>" method="POST"
			...
			<input type="hidden" name="id" value="<?php echo $resid; ?>"> <input
				...
				for="reservationStatus">status:</label>
