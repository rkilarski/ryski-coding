...
?>
	...
	<form name="checkout" id="checkout" method="post"
		...
		<?php include('../include/ordertypeselect.php'); ?>
			...
			type="email" size="40" name="email" placeholder="email address" maxlength="255" required="required"
			value="<?php echo $email;?>"> <br> <label for="firstname">first name:</label><input
			type="text" name="firstname" placeholder="first name" maxlength="255" required="required"
			value="<?php echo $first;?>"> <br> <label for="middlename">middle
			initial:</label><input type="text" name="middle" placeholder="m" maxlength="255"
			size="1" value="<?php echo $middle;?>"> <br> <label for="lastname">last
			name:</label><input type="text" name="lastname" placeholder="last name" maxlength="255"
			required="required" value="<?php echo $last;?>"> <br> <label
			for="addressline1">address line 1:</label><input type="text"
			name="addressline1" id="addressline1" size="40" placeholder="address line 1" maxlength="255" required="required"
			value="<?php echo $addrl1;?>"> <br> <label for="addressline2">address
			line 2:</label><input type="text" name="addressline2" placeholder="address line 2" id="addressline2" size="40" maxlength="255"
			value="<?php echo $addrl2;?>"> <br> <label for="city">city:</label><input
			type="text" name="city" id="city" placeholder="city" maxlength="25" required="required"
			...
			name="zip" id="zip" maxlength="10" placeholder="zip" size="10" required="required"
			value="<?php echo $zip;?>"> <br> <label for="telephone">telephone:</label><input
			type="tel" class="telephone" id="telephone" name="telephone" placeholder="telephone" maxlength="15" required="required"
			value="<?php echo $tel;?>">
		</div>
		</fieldset>
		...
		<div class="center">
			<input type="button" id="copyaddress" value="copy from delivery address">
		</div>
		<br>
		<label
			for="billingAddressline1">address line 1:</label><input type="text"
			name="billingAddressline1" id="billingAddressline1" size="40" maxlength="255" placeholder="address line 1" required="required"> <br> <label for="billingAddressline2">address
			line 2:</label><input type="text" name="billingAddressline2" id="billingAddressline2" placeholder="address line 2" size="40" maxlength="255"> <br> <label for="billingCity">city:</label><input
			type="text" name="billingCity" id="billingCity" maxlength="25" placeholder="city" required="required"> <br> <label for="billingState">state:</label> 
		
			<?php $stateLabel='billingState'; include('../include/stateselect.php');?>
			
			<br> <label for="billingZip">zip:</label><input type="text"
			name="billingZip" placeholder="zip" id="billingZip" maxlength="10" size="10" required="required"> <br> <br> <label for="cctype">credit card
