...
/**
 * The base class for the chord chart area table model wrapper that holds chord chart objects. Extends from AbstractTableModel and implements Serializable
 * interface.
 * 
...
public abstract class BaseChordChartAreaTableAdapter extends AbstractTableModel implements Serializable
{
	...
	/**
	 * Inserts a new row above the row specified by index. All rows beneath the index will get pushed down.
	 * 
	 * @param index
