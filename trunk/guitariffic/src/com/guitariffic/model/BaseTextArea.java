...
public abstract class BaseTextArea implements Serializable
{
	...
	/**
	 * 	Returns the enumerated type for the current text area
	 * 	so that its controller knows how to manage it.
	 * 
	 * 	@return  the type of text area being used in the 
	 * 	current display; 
	 */
	abstract public EnumTextAreaType getTextAreaType();

	/**
	 * 	Returns the <code>Component</code> that appears in
	 * 	the left pane of the application.
	 * 
	...
	/**
	 * 	Sets the implemented TextArea component for the current
	 * 	view.
	 * 
	 * 	@param   textArea   swing component that holds the text area.
	 */
	abstract public void setTextAreaControl(Component textArea);

	/**
	 * 	Returns the entire text in the text area pane as a single
	 * 	string.
	 * 
	...
	/**
	 * 	Returns the text in the text area pane as an array of
	 * 	strings representing the individual lines of the text
	 * 	area. Each of these lines are associated with an <code>
	 * 	EnumTextLineType</code>.
	 * 
	 * 	@return  string array carrying each line in the text
	 * 	area display. 
	 */
