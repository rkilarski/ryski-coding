 ...
 * 
 * Deitel "Java How To Program", page 1117: 26.11
 * This very brief problem statement points us to the example of section 26.8, which is shown in
 * Figures 26.18 and 26.19 which uses the technique of "bounded buffers". Then, it asks us to
 * re-implement that example using the "Lock and Condition Interfaces" technique of section 26.9.
 * This section already contains an example which uses "Lock and Condition Interfaces", which is
 * illustrated in Figures 26.20 and 26.21. However, this illustration does not contain the
 ...
 * picture of the waterfall on the book cover in the upper left. Then, look at the menu on the
 * right of that book cover and click on "Code Examples". This will show you a selection of all of
 * the chapters in the book. Select Chapter 26, which is a zip file, then download it. The zip file
 * can be expanded into a folder which contains all of the examples of Chapter 26.
 *
 * 
 * Notes:
 * The Producer, Consumer, and Buffer classes were not modified in any way in this exercise. Only
 * CircularBuffer was modified.
 * This class was also not modified, except for the insertion of this comment.
 */
