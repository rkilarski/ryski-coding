...
public class TestRationalStaticMain {

	public static void main(String[] args) {
		TestRationalStaticMain testClass = new TestRationalStaticMain();

		testClass.testNumeratorAccessors();
		testClass.testDenominatorAccessors();
		testClass.testRationalConstructors();
		testClass.testAdd();
		testClass.testSubtract();
		testClass.testMultiply();
		testClass.testDivide();
		testClass.testReciprocal();
		testClass.testToString();
		testClass.testToFloat();
	}

	private static void assertEquals(int item1, int item2) {
		if (item1 == item2) {
			System.out.println("   Test Passes: Item " + item1 + " and item "
					+ item2 + " are equal.");
		} else {
			System.out.println("   Test FAILS: Item " + item1 + " and item "
					+ item2 + " are not equal.");
		}
	}

	private static void assertEquals(String item1, String item2) {
	...
	private static void assertTrue(boolean value) {
		if (value) {
			System.out.println("   Test Passes: Item is true.");
		} else {
			System.out.println("   Test FAILS: Item is false.");
		}
