...
(2, 'Ryszard', NULL, 'Kilarski', aes_encrypt('rkilarski@gmail.com','chickenrice'), aes_encrypt('password','chickenrice'), aes_encrypt('99 pond ave apt 701','chickenrice'), NULL, aes_encrypt('brookline','chickenrice'), aes_encrypt('ma','chickenrice'), aes_encrypt('02445','chickenrice'), '6179534258', 'N', NULL, NULL, 'N'),
(3, 'Bad', 'C', 'Customer', aes_encrypt('badcustomer@gmail.com','chickenrice'), aes_encrypt('password','chickenrice'), aes_encrypt('no address','chickenrice'), NULL, aes_encrypt('boston','chickenrice'), aes_encrypt('ma','chickenrice'), aes_encrypt('02445','chickenrice'), '6179534258', 'N', 'Y', 'This is a bad client, never pays.', 'N');