...
public class RESTClient {
    ...
    public static void main(String[] args) throws AxisFault {
        ...
        // testElementOMElement("Testing:  updateOrder", testUpdateOrder("b3"));
        // testElementOMElement("Testing:  results of updateOrder a1", testGetOrder("b3"));
    ...
    private static synchronized void testElementOMElement(String testTitle, OMElement element,
            boolean robust) throws AxisFault {
        if (element != null) {
