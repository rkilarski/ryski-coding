...
/**
 * Transfer handler for the table drag and drop functionality. This is to transfer data from the
 * chord tray. Note that canImport() returns false which means that you can move chords out of the
 * chord tray, but not change the tray order.
 * 
